...
function LoadLangTT() {
   ...
   if (configtt.lang == "english") {
      ...
      nosteamtt = "Hides the default Steam notification<br>when unlocking an achievement.<br><span style='color: red; font-weight: bold'>Enabling this option will restart Steam.</span>";
      ...
      nosteamtt = "يخفي إشعار Steam الافتراضي <br> عند فتح أحد الإنجازات.<br><span style='color: red; font-weight: bold'>سيؤدي تمكين هذا الخيار إلى إعادة تشغيل Steam.</span>";
      ...
      nosteamtt = "Скрива известието по подразбиране на<br>Steam при отключване на постижение.<br><span style='color: red; font-weight: bold'>Активирането на тази опция ще рестартира Steam.</span>";
      ...
      nosteamtt = "在解锁成就时隐藏默认 Steam 通知。<br><span style='color: red; font-weight: bold'>启用此选项将重新启动 Steam。</span>";
      customisett = "自定义成就通知";
      eyett = "显示/隐藏 API Key";
      kofitt = "在 Ko-Fi 上捐款！";
      ...
      nosteamtt = "在解鎖成就時隱藏默認 Steam 通知。*<br><span style='color: red; font-weight: bold'>啟用此選項將重新啟動 Steam。</span>";
      customisett = "自定義成就通知";
      eyett = "顯示/隱藏 API Key";
      kofitt = "在 Ko-Fi 上捐款！";
      trackopacitytt = "设置“追踪”通知的不透明度。";
      ...
      nosteamtt = "Skryje výchozí oznámení<br>Steam při odemykání úspěchu.<br><span style='color: red; font-weight: bold'>Povolením této možnosti restartujete Steam.</span>";
      ...
      nosteamtt = "Skjuler standard Steam-meddelelsen<br>når du låser op for en præstation.<br><span style='color: red; font-weight: bold'>Aktivering af denne mulighed genstarter Steam.</span>";
      ...
      nosteamtt = "Verbergt de standaard Steam-melding<br>bij het ontgrendelen van een prestatie.<br><span style='color: red; font-weight: bold'>Als u deze optie inschakelt, wordt<br>Steam opnieuw gestart.</span>";
      ...
      nosteamtt = "Piilota oletusarvoinen Steam ilmoitus,<br>kun saavutus avataan.<br><span style='color: red; font-weight: bold'>Tämän vaihtoehdon käyttöönotto<br>käynnistää Steamin uudelleen.</span>";
      ...
      nosteamtt = "Masque la notification Steam par défaut<br>lors du déverrouillage d'un succès.<br><span style='color: red; font-weight: bold'>L'activation de cette option redémarrera Steam.</span>";
      ...
      nosteamtt = "Blendet die standardmäßige Steam Benachrichtigung<br>beim freischalten eines Errungenschafts aus.<br><span style='color: red; font-weight: bold'>Wenn Sie diese Option aktivieren, wird Steam neu gestartet.</span>";
      ...
      nosteamtt = "Αποκρύπτει την προεπιλεγμένη ειδοποίηση Steam<br>κατά το ξεκλείδωμα ενός επιτεύγματος.<br><span style='color: red; font-weight: bold'>Η ενεργοποίηση αυτής της επιλογής θα επανεκκινήσει το Steam.</span>";
      ...
      nosteamtt = "Elrejti az alapértelmezett Steam<br>értesítést egy jutalom feloldásakor.<br><span style='color: red; font-weight: bold'>Ennek az opciónak a bekapcsolásával<br>újraindul a Steam.</span>";
      ...
      nosteamtt = "Nasconde la notifica predefinita di Steam<br>quando si sblocca un obiettivo.<br><span style='color: red; font-weight: bold'>L'abilitazione di questa opzione riavvierà Steam.</span>";
      ...
      nosteamtt = "アチーブメントのロックを解除するときに、<br>デフォルトのSteam通知を非表示にします。<br><span style='color: red; font-weight: bold'>このオプションを有効にすると、Steamが再起動します。</span>";
      ...
      nosteamtt = "업적을 잠금 해제할 때기본<br> Steam 알림을 숨깁니다.<br><span style='color: red; font-weight: bold'>이 옵션을 활성화하면 Steam<br>이 다시 시작됩니다.</span>";
      ...
      nosteamtt = "Skjuler standard Steam-varsling<br>når du låser opp en prestasjon.<br><span style='color: red; font-weight: bold'>Aktivering av dette alternativet<br>vil starte Steam på nytt.</span>";
      ...
      nosteamtt = "Ukrywa domyślne powiadomienie Steam<br>w trakcie odblokowania osiągnięcia.<br><span style='color: red; font-weight: bold'>Włączenie tej opcji spowoduje<br>ponowne uruchomienie Steam.</span>";
      ...
      nosteamtt = "Oculta a notificação padrão do Steam<br>ao desbloquear uma conquista.<br><span style='color: red; font-weight: bold'>Ativar esta opção irá reiniciar o Steam.</span>";
      ...
      nosteamtt = "Ascunde notificarea implicită Steam<br>la deblocarea unei realizări.<br><span style='color: red; font-weight: bold'>Activarea acestei opțiuni va reporni Steam.</span>";
      ...
      nosteamtt = "Скрывает уведомление Steam по умолчанию<br>при разблокировке достижения.<br><span style='color: red; font-weight: bold'>Включение этой опции приведет к перезапуску Steam.</span>";
      ...
      nosteamtt = "Oculta la notificación de Steam predeterminada<br>al desbloquear un logro.<br><span style='color: red; font-weight: bold'>Habilitar esta opción reiniciará Steam.</span>";
      ...
      nosteamtt = "Döljer Steam standardaviseringen<br>när en prestation låses upp.<br><span style='color: red; font-weight: bold'>Om du aktiverar det här alternativet startas Steam om.</span>";
      ...
      nosteamtt = "ซ่อนการแจ้งเตือน Steam เริ่มต้น<br>เมื่อปลดล็อกรางวัลพิเศษ<br><span style='color: red; font-weight: bold'>การเปิดใช้งานตัวเลือกนี้จะเป็นการรีสตาร์ท Steam</span>";
      ...
      nosteamtt = "Bir başarının kilidini açarken<br>varsayılan Steam bildirimini gizler.<br><span style='color: red; font-weight: bold'>Bu seçeneği etkinleştirmek Steam'i yeniden başlatır.</span>";
      ...
      nosteamtt = "Приховує сповіщення Steam за умовчанням<br>під час розблокування досягнення.<br><span style='color: red; font-weight: bold'>Увімкнення цієї опції перезапустить Steam.</span>";
      ...
      nosteamtt = "Ẩn thông báo Steam mặc định<br>khi mở khóa thành tích.<br><span style='color: red; font-weight: bold'>Bật tùy chọn này sẽ khởi động lại Steam.</span>";
